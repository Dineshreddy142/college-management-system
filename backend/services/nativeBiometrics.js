...
// Configurable match threshold from environment (SFace precision target: 0.52)
export const BIOMETRIC_MATCH_THRESHOLD = parseFloat(process.env.BIOMETRIC_MATCH_THRESHOLD || '0.52');
